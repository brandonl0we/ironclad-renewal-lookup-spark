...
- Searches Ironclad contract records through ACOS-Data.
...
Spark auto-detects this as a Next.js app. The `spark.json` requests read access to the `ironclad` ACOS-Data vendor. The app uses only read endpoints.
